      ...
      <div class="list-group list-group-flush mx-3 mt-4 ">
        ...
        > -->
          ...
          if ($checkLogsReturn == 1) { ?>
            ...
            <a href="<?= LOGS_BOOK_PATH ?>" class="list-group-item list-group-item-action py-2 ripple">
              <i class="fas fa-chart-line fa-fw me-3"></i><span>LOGS</span>
            </a>

            <a href="<?= USER_PATH ?>permission" class="list-group-item list-group-item-action py-2 ripple">
          ...
          if ($checkbookReturn == 1) { ?>
            ...
            <a href="<?= BOOK_PATH ?>view_users" class="list-group-item list-group-item-action py-2 ripple">
              <i class="bi bi-book"></i><span>Users</span>
            </a>
          ...
          <!-- <a href="<?= BOOK_PATH ?>country" class="list-group-item list-group-item-action py-2 ripple">
              <i class="bi bi-book"></i><span>Tables Join</span>
            </a> -->
